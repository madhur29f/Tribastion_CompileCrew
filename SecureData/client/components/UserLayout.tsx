          ...
          {navItems.map((item) => {
            ...
            return (
              <button
                ...
                className="w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-all duration-200 text-sidebar-foreground hover:bg-sidebar-accent"
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="bg-card border-b border-border px-8 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h2 className="text-lg font-semibold text-foreground hidden md:block">Protected Data View</h2>
          </div>
